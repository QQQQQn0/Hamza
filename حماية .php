...
ob_start();
error_reporting(0);
define('API_KEY','6429478280:AAENIVpoN0oI_KXh2y6dE7erUrUKy_op3H8');
...
$Dev = array("6793770465","6793770465","6793770465"); //ID ADMIN NUMBER 1 HE CHAT
@$usernamebot = "bbbwiwiwbot"; //UserName Bot
@$channel = "QQQQn0"; // UserName Channel don't @
@$token = API_KEY;
